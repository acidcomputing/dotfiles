...
# Archived: I don't use PowerLevel 10K anymore
# Generated by Powerlevel10k configuration wizard on 2025-04-29 at 01:20 CST.
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  # Current directory background color. 44
